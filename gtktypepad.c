...
#define APP_TITLE                  "GtkTypePad"
#define APP_NAME                   "gtktypepad"
#define APP_VERSION                "0.0.1"
#define APP_URL                    "http://mattn.kaoriya.net/gtktypepad.xml"
#define SERVICE_NAME               "typepad"
#define SERVICE_UPDATE_URL         "http://twitter.api.typepad.com/statuses/update.xml"
#define SERVICE_SELF_STATUS_URL    "http://twitter.api.typepad.com/statuses/friends_timeline.xml"
#define SERVICE_USER_STATUS_URL    "http://twitter.api.typepad.com/statuses/user_timeline/%s.xml"
#define SERVICE_THREAD_STATUS_URL  "http://twitter.api.typepad.com/statuses/thread_timeline/%s.xml"
...
static gpointer post_status_thread(gpointer data) {
	...
	headers = curl_slist_append(headers, "X-TypePad-Client: "APP_NAME);
	headers = curl_slist_append(headers, "X-TypePad-Client-Version: "APP_VERSION);
	headers = curl_slist_append(headers, "X-TypePad-Client-URL: "APP_URL);
